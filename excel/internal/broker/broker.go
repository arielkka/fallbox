...
func (b *Broker) CreateQueues() error {
	err := b.client.CreateQueue(b.cfg.Service.Message.DocumentExcelGet, false)
	if err != nil {
		return err
	}

	err = b.client.CreateQueue(b.cfg.Service.Message.DocumentExcelDelete, false)
	if err != nil {
		return err
	}

	err = b.client.CreateQueue(b.cfg.Service.Message.DocumentExcelSend, false)
	if err != nil {
		return err
	}
